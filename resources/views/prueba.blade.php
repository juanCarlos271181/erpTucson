...
<body class="contenedorLogin2">
  ...
  <form class="container2 mt-3"id="prueba">
    ...
    <div class="row">
      <div class="formulario_grupo col-4 mb-3" id="input__usuario">
      ...
      <div class="col-4 mb-3" id="input__nombre">
      ...
      <div class="row">
        <div class="col-4 mb-3" id="input__password">
        ...
        <div class="col-4 mb-3" id="input__password2">
        ...
        <div class="row">
          <div class="col-4 mb-3" id="input__correo">
          ...
          <div class="col-4 mb-3" id="input__telefono">
        ...
        <div class="loginPrueba mt-3">
          <button type="submit" class="btn btn-primary" id="btnEnviar">Enviar</button>
          <p class="formulario_mensaje-exito mt-3" id="formulario_mensaje-exito">Formulario enviado exitosamente</p>
        </div>
